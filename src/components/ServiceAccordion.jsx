...
export default function ServiceAccordion({
  ...
  const handleCopyUrl = (service) => {
    const urlToCopy =
      service.repo_url || service.url || service.service_name || "";
    navigator.clipboard
      .writeText(urlToCopy)
      .then(() => {
        ...
        return (
          ...
          >
            <div style={{ padding: "20px 0" }}>
              ...
              >
                <div className="bg-[#f1f5f9] border border-[#e2e8f0] rounded-md p-2 inline-flex items-center">
                  <Text
                    strong
                    style={{
                      fontSize: "12px",
                  ...
                  <Text style={{ fontSize: "12px", color: "#1e293b" }}>
                    {branchName}
                  </Text>
                </div>
                        ...
                        actions={[
                          branch.build_number && (
                            <Button
                              ...
                              type="text"
                              onClick={() =>
                                onGetBuildArtifacts(branch.build_number)
                              }
                          ...
                          <Popconfirm
                            ...
                            onConfirm={() =>
                              onDeleteBranch(service.id, branch.id)
                            }
                            okText="Yes, Delete"
                            cancelText="Cancel"
                          >
